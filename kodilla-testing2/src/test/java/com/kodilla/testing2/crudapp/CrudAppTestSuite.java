...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://nikorenos.github.io/";
    ...
    private String createCrudAppTestTask() throws InterruptedException {
        final String XPATH_TASK_NAME = "//form[contains(@action, \"tasks\")]/fieldset[1]/input[1]";
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("mbalabox@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("alkahar11");
